...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 28 15:18:22 2018

@author: nguyentran

Entities in IoTSE, used by components for communication and operation
"""
...
def main():
    iot_content = IoTContent("resource 1", {"type" : "sensor data"}, {"temperature" : 234})
    print(iot_content.__dict__)
