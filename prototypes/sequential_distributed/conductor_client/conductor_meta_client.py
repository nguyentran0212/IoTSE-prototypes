...
WF_SERVER_PATH = "http://192.168.99.102:8080/api"
...
if __name__ == "__main__":
    add_task("./wf_defs/iotse_prototype_task_def.json")
    add_workflow("./wf_defs/iotse_prototype_wf_interlaced_def_2.json")
