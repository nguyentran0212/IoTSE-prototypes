...
class AbsDetectorService(AbsService):
    ...
    def detect(self):
        ...
        res_ids = self._invoke_method("_detect", [], [list])
        return res_ids
...
class AbsCollectorService(AbsService):
    ...
    def collect(self, urlList, curr_host):
        result = self._invoke_method("_collect", [(urlList, "urlList", list)])
    ...
    def lookup(self, timestamp):
        result = self._invoke_method("_lookup", [(timestamp, "timestamp", str)])
        return result
...
class AbsStorageService(AbsService):
    ...
    def insert(self, res_contents_url):
        """
        Retrieve set of resources at the targeted URL and insert them
        to the database
        """
        result = self._invoke_method("_insert", [(res_contents_url, "res_contents_url", str)])
        return result
    
    def getSingleResource(self, res_id):
        """
        Get a single resource from the storage
        """
        result = self._invoke_method("_getSingleResource", [(res_id, "res_id", str)])
        return result
...
class AbsSearchService(AbsService):
    ...
    def query(self, query):
        ...
        """
        result = self._invoke_method("_query", [(query, "query", dict)])
        return result
    ...
    def getResult(self, result_id):
        ...
        """
        result = self._invoke_method("_getResult", [(result_id, "result_id", str)])
        return result
