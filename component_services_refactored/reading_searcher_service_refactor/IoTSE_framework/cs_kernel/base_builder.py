...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 11 17:42:22 2018
...
class ComponentServiceBuilder:
    ...
    def combine(self, other_builder):
        """
        Add mapping of another builder to the current builder, resulting
        in a new builder that generates hybrids of two service types
        """
        self.mapping.update(other_builder.mapping)
        return self
